...
public class CookieServlet extends HttpServlet {
    ...
    /* comment.
    *   Cookie 는 클라이언트(브라우저) 와 서버 간에 상태 정보를 유지하기 위해 사용되는 작은 데이터 저장 공간이다.
    ...
    * */
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        Cookie cookie = new Cookie("userValue", cookieValue);   // 쿠키 구조 : 이름, 값
        cookie.setMaxAge(60 *60);   // 1시간 만료 설정     - 1시간 뒤 쿠키 파괴됨.
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.setAttribute("saveValue", saveValue);

        // 지금까지 우리는 path에 요청을 처리할 수 있는 서블릿 클래스만 넣었었다.
