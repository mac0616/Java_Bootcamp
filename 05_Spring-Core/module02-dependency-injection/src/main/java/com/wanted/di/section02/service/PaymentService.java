...
public class PaymentService {
    ...
    *   - Service 에서 PaymentInterface를 의존하려고 할 때 Error가
    *   - 발생하는 이유는 PaymentInterface를 상속받은 구현체가 2개이기
    *   - 때문에 어떤 Bean을 주입해야 할 지 모르기 때문에 발생하는 Error이다.
    *  */
    @Autowired
    public PaymentService(/* @Qualifier("naverPayGateway") */PaymentInterface paymentInterface){
