...
export const callProductListAboutMealAPI = () => {
	const requestURL = `http://${import.meta.env.VITE_APP_RESTAPI_IP}:8080/api/v1/products/meals`;
...
export const callProductListAboutDessertAPI = () => {
	const requestURL = `http://${import.meta.env.VITE_APP_RESTAPI_IP}:8080/api/v1/products/dessert`;
...
export const callProductListAboutBeverageAPI = () => {
	const requestURL = `http://${import.meta.env.VITE_APP_RESTAPI_IP}:8080/api/v1/products/beverage`;
